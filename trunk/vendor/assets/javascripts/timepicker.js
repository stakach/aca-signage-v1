...
Timepicker.prototype = {
    init: function()
    {
        ...
        this._colonPos  = -1;
        this._visible   = false;
        this.tpDiv      = $('<div id="' + this._mainDivId + '" class="ui-datepicker ui-widget ui-widget-content ui-helper-clearfix ui-corner-all" style="z-index: 99999; width: 100px; display: none; position: absolute;"></div>');
        this._generateHtml();
    },
    ...
    _generateHtml: function ()
    {
        ...
        html += '<tr><td align="center" style="padding-left:20px;"><div id="hourSlider" class="slider"></div></td><td align="center" style="padding-left:20px;"><div id="minuteSlider" class="slider"></div></td></tr>';
        html += '</table>';
