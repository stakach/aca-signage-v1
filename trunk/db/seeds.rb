...
FileConversion.create(
	...
	:applies_to => ".avi .mpg .mov .wmv .mpeg .webm .ogv .ogg .m4v .mp4",
	:command => '["-codec:v libvpx -quality good -cpu-used 0 -qmin 10 -qmax 42 -maxrate 25000k -bufsize 1000k -threads 2","-codec:a libvorbis -b:a 128k"]',
...
FileConversion.create(
	...
	:applies_to => ".m4a .aac .ogg .oga .mp3 .wav",
	:command => '-codec:a libvorbis -b:a 128k -strict experimental',
